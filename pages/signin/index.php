...
<body>
    <div class="d-flex flex-column" style="min-height: 100vh;">
        <div class="system-nav">
            ...
            <?php include '../reusable/dashboard/logged_out.php'; ?>
        </div>
        ...
        <div class="system-wrapper p-1">
            ...
            <div class="card wrapper-card m-0 p-1 w-100 flex-grow-1 d-flex flex-column border rounded border-info position-relative">
